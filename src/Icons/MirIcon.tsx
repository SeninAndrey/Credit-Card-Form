...
export function MirIcon() {
    return (
        <svg width="50px" height="40px" viewBox="0 0 400 120" xmlns="http://www.w3.org/2000/svg"><linearGradient id="a" x1="370" x2="290" gradientUnits="userSpaceOnUse">
            <stop stopColor="#1F5CD7"/>
            <stop stopColor="#02AEFF" offset="1"/></linearGradient>
